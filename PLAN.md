...
| **S5** | кварталы | Один scheduler: ресурсы рендера в ECS, автопараллелизм по доступам, без extract | 🟡 S5a+S5b ✅ CI (a8bb49c); S5c реализовано 2026-08-19 (`order_before` в графе и ядре, рёбра в уровнях, bench levels) — проверка CI |
