...
| **S5** | кварталы | Один scheduler: ресурсы рендера в ECS, автопараллелизм по доступам, без extract | 🟡 S5a ✅ CI (2026-08-19, 32343410418): шедулер ядра + levels() (**найден lighting ∥ forward**); S5b/c — миграция исполнения, `.before/.after`, bench |
