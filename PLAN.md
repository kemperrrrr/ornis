...
| **S5** | кварталы | Один scheduler: ресурсы рендера в ECS, автопараллелизм по доступам, без extract | 🟡 S5a-фундамент 2026-08-19: шедулер ядра + levels(); миграция рендера и `.before/.after` — S5b/c |
