    ...
    pub fn new(device: &wgpu::Device, surface_format: wgpu::TextureFormat) -> Self {
        ...
        let bgl_entries: Vec<wgpu::BindGroupLayoutEntry> =
            crate::shaders::composite_generated::COMPOSITE_RESOURCES
                .iter()
                .map(|r| crate::shaders::bgl_entry(r, false))
                .collect();
        ...
        let pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            vertex: wgpu::VertexState {
                module: &shader,
                entry_point: Some(crate::shaders::composite_generated::vs_main::entry_point()),
                buffers: &[],
                compilation_options: wgpu::PipelineCompilationOptions::default(),
            },
            fragment: Some(wgpu::FragmentState {
                module: &shader,
                entry_point: Some(crate::shaders::composite_generated::fs_main::entry_point()),
...
mod tests {
    ...
    fn composite_shader_validates_with_naga() {
        ...
        validator
            .validate(&module)
            .unwrap_or_else(|e| panic!("composite shader must validate: {e}"));
    }
