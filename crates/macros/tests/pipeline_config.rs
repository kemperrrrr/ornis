//! Tests for `PipelineConfig` derive macro code generation.

// Fixture struct fields are not read directly: the tests check
// only the constants/functions generated by the derive macro.
#![allow(dead_code)]
