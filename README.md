...
- **Performance benchmarks** (`.github/workflows/performance.yml`) — отдельный
  ...
  - targeted 100k probe `33245718111` от 2026-08-29 успешно измерил tiled-floor UniformGrid `cell_size = 8.0`: после первого шага около `8.02 s/step`, `13448` cells, `2349246` raw pair tests и `100000` candidates; SAP на том же targeted probe ещё не измерен, отдельный timing breakdown также впереди;
