# T13 Hardening Plan — историческая заметка о публичных API физики

> **Статус:** архивный план расследования от 2026-08-23. Рабочая
> реализация завершена и описана в `t13-followups.md`; этот файл
> сохраняется как annotated history, а не как ожидающая согласования
> задача.
...
> ⚠️ Команды и шаги ниже — историческая процедура; текущий
> результат не требует отдельного согласования или нового PR.
>
...
На момент написания ожидался feedback по вопросам clamp/max_iter/макроса;
последующий фактический результат зафиксирован в `t13-followups.md`.
