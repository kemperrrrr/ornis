# Мутант-тикеты — ornis-core, исторический прогон 2026-08-11

> **Статус:** архивный отчёт о прогоне и закрытых тикетах, а не
> текущий список работ. Итоговый результат этого раунда уже записан
> ниже: 2 оставшихся мутанта классифицированы как эквивалентные.
>
